...
//  PicasongFinal
//
//  Created by Caleb Mitcler on 8/11/19.
//  Copyright © 2019 Caleb Mitcler. All rights reserved.
//
...
class ViewController: UIViewController, SPTSessionManagerDelegate, SPTAppRemoteDelegate, SPTAppRemotePlayerStateDelegate {
	...
	fileprivate let SpotifyClientID = "0f8be8fa7e9e4ca2acb2109b1b9b441a"
	fileprivate let SpotifyRedirectURI = URL(string: "spotify-ios-quick-start://spotify-login-callback")!
	lazy var configuration: SPTConfiguration = {
		let configuration = SPTConfiguration(clientID: SpotifyClientID, redirectURL: SpotifyRedirectURI)
		configuration.tokenSwapURL = URL(string: "https://picasongemoji.herokuapp.com/api/token")
		configuration.tokenRefreshURL = URL(string: "https://picasongemoji.herokuapp.com/api/refresh_token")
